...
<div class="d-flex bd-highlight mb-5">
    <div class="mr-auto p-2 bd-highlight h2">冷蔵庫の食材</div>
    <div class="p-2 bd-highlight"><a href="{{ route('freezer') }}" class="btn btn-outline-info mr-2">冷凍庫を確認する</a></div>
    <div class="p-2 bd-highlight"><a href="{{ route('vegetable') }}" class="btn btn-outline-success mr-2">野菜室を確認する</a></div>
</div>

<!-- 検索フォーム -->
<div class="row" style="padding-bottom: 30px; margin-left: 0px; margin-right: 15px;">
    <div class="col-sm-10" style="padding-left:0;">
        <form method="get" action="{{ route('refrigerator') }}" class="form-inline">
...
<table class="table mb-3">
    ...
    <tbody>
        @foreach ($refrigerator_foods as $food)
            <tr>
